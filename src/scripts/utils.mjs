  ...
  return `
    <div id="waves-container">
        <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
            ...
            <g class="parallax">
                <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(255,255,255,0.25" />
                ...
                <use xlink:href="#gentle-wave" x="48" y="7" fill="rgba(255,255,255,0.35)" />
            </g>
        </svg>
        <div id="wave-placeholder"></div>
    </div>
    `
}

export function renderAnimatedWave() {
  document.querySelector('main').insertAdjacentHTML('afterbegin', animatedWaveContent());
